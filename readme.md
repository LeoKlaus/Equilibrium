...
### Todo
- [ ] Frontend for Android/Web (I started work on a flutter based version, but I'm not very familiar with flutter)
...
I ordered 2 versions of the top printed in clear and translucent resin ([Top-Threaded.stl](Extras/3D%20Models/Top-Threaded.stl)) and will update the repo once I received them.
...
As of now, the only way to configure Equilibrium is the API, besides the [iOS app](https://github.com/LeoKlaus/Equilibrium-iOS) (which you would have to build yourself until it becomes available on TestFlight).
