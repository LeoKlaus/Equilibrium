...
As of now, the only way to configure Equilibrium is the API, besides the [iOS app](https://github.com/LeoKlaus/Equilibrium-iOS) (which is now available on TestFlight here: https://testflight.apple.com/join/dyzEZYMs).
